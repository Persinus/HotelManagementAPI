...
public class DichVuDTOValidator : AbstractValidator<DichVuDTO>
{
    public DichVuDTOValidator()
    {
        // MaDichVu có thể null hoặc empty khi tạo mới, nếu cần validate thì thêm rule
