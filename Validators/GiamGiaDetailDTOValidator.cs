...
public class GiamGiaDetailDTOValidator : AbstractValidator<GiamGiaDetailDTO>
{
    public GiamGiaDetailDTOValidator()
    {
        RuleFor(x => x.MaGiamGia)
            .NotEmpty().WithMessage("Mã giảm giá là bắt buộc.")
            .Length(6).WithMessage("Mã giảm giá phải đúng 6 ký tự.");
